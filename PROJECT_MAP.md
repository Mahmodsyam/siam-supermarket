...
| أخضر غامق | `#1E3F20` | Header, Footer, خلفية Hero |
| أخضر متوسط | `#2E5A44` | أيقونات الاتصال, Gallery |
...
**نسبة التوزيع:** 60% أبيض/محايد + 30% أخضر/رمادي فحمي + 10% ذهبي
...
| Gold palette applied | PASS | `#C5A059` في الأزرار، `#1E3F20` في الهيدر |
